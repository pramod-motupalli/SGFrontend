...
const RedLightGreenLight = () => {
  ...
  const questions = [
    ...
    // },
    {
      ...
      expected: '#include<stdio.h>intsumOfDigits(int n){intsum=0;while(n>0){sum+=n%10;n=n/10;}returnsum;}intmain(){intnum=312672;printf("Sumofdigitsof%dis%d",num,sumOfDigits(num));return0;}',
    },
  ];
